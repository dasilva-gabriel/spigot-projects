...
public class GTPCommand extends Command implements TabExecutor {

	public GTPCommand(String name, String permission, String[] aliases) {
	...
	public void execute(CommandSender sender, String[] arg) {
		...
		if (arg.length > 0) {
			String name = arg[0];
	        WarCore.getInstance().getModules().getGtp().teleport(p, name);
	        
		} else {
			BaseComponent msg1 = new TextComponent("Utilisation de la commande: ");
			BaseComponent msg2 = new TextComponent("/gtp <pseudo>");
