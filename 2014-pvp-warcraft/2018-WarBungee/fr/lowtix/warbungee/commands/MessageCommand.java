...
public class MessageCommand extends Command {
	...
	public MessageCommand() {
		super("msg", "", new String[] { "w","m","t","pm","emsg","epm","tell","etell","whisper","ewhisper"});
	}
	...
	public void execute(CommandSender sender, String[] args) {
		...
		if (args.length >= 2) {
			...
			if(name.equalsIgnoreCase(player.getName())) {
				player.sendMessage(new TextComponent("§8[§3§lW§fInfo§8] §cVous ne pouvez pas vous envoyer des messages a vous même!"));
				return;
			}
			...
			player.sendMessage(new TextComponent("§8[§3§lW§fInfo§8] §6Pour envoyer un message §e/message <joueur> <message>§6."));
		}
