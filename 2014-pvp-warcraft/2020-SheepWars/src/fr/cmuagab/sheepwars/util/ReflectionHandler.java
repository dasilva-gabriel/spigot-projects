...
public final class ReflectionHandler {
    ...
    */
    public enum DataType {
        ...
        public static Class<?> getPrimitive(final Class<?> c) {
            final DataType t = DataType.fromClass(c);
    ...
    */
    public enum PackageType {
        MINECRAFT_SERVER("net.minecraft.server." + Bukkit.getServer().getClass().getPackage().getName().substring(23)), CRAFTBUKKIT(Bukkit.getServer().getClass().getPackage().getName());
    ...
    */
    public enum PacketType {
        ...
        public Class<?> getPacket() throws Exception {
            return this.packet == null ? this.packet = ReflectionHandler.getClass(this.name, PackageType.MINECRAFT_SERVER) : this.packet;
        }
    }
    ...
    */
    public enum SubPackageType {
        BLOCK, CHUNKIO, COMMAND, CONVERSATIONS, ENCHANTMENTS, ENTITY, EVENT, GENERATOR, HELP, INVENTORY, MAP, METADATA, POTION, PROJECTILES, SCHEDULER, SCOREBOARD, UPDATER, UTIL;
    ...
    public static void setDeclaredValue(final Class<?> clazz, final Object instance, final String fieldName, final Object fieldValue) throws Exception {
        final Field f = ReflectionHandler.getDeclaredField(clazz, fieldName);
    ...
    public static void setDeclaredValue(final Object instance, final String fieldName, final Object fieldValue) throws Exception {
        final Field f = ReflectionHandler.getDeclaredField(instance.getClass(), fieldName);
        f.set(instance, fieldValue);
    }
    ...
    public static void setValue(final Class<?> clazz, final Object instance, final String fieldName, final Object fieldValue) throws Exception {
        final Field f = ReflectionHandler.getField(clazz, fieldName);
        f.set(instance, fieldValue);
    }
    ...
    public static void setValue(final Object instance, final String fieldName, final Object fieldValue) throws Exception {
        final Field f = ReflectionHandler.getField(instance.getClass(), fieldName);
        f.set(instance, fieldValue);
    }
