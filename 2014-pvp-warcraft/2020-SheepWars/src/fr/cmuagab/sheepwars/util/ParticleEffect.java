...
import fr.cmuagab.sheepwars.util.ReflectionHandler.PacketType;
import fr.cmuagab.sheepwars.util.ReflectionHandler.SubPackageType;
...
public enum ParticleEffect {
    ...
    ICON_CRACK("iconcrack_{subtype}"), BLOCK_CRACK("blockcrack_{subtype}"), TILE_CRACK("tilecrack_{subtype}");
