...
public class UnRankedGui extends Gui {
	...
	public UnRankedGui(Player player) {
		super("§e§lUnRanked §8■ §a1vs1", 5, player);
	}

	@Override
	public void drawScreen() {
		
		setItem(0, new ItemBuilder(Material.STAINED_GLASS_PANE).setDamage(4).setName("  ").build());
		setItem(1, new ItemBuilder(Material.STAINED_GLASS_PANE).setDamage(0).setName("  ").build());
		setItem(2, new ItemBuilder(Material.STAINED_GLASS_PANE).setDamage(4).setName("  ").build());
		setItem(3, new ItemBuilder(Material.STAINED_GLASS_PANE).setDamage(0).setName("  ").build());
		setItem(4, new ItemBuilder(Material.STAINED_GLASS_PANE).setDamage(4).setName("  ").build());
		setItem(5, new ItemBuilder(Material.STAINED_GLASS_PANE).setDamage(0).setName("  ").build());
		setItem(6, new ItemBuilder(Material.STAINED_GLASS_PANE).setDamage(4).setName("  ").build());
		setItem(7, new ItemBuilder(Material.STAINED_GLASS_PANE).setDamage(0).setName("  ").build());
		setItem(8, new ItemBuilder(Material.STAINED_GLASS_PANE).setDamage(4).setName("  ").build());
		...
		setItem(18, new ItemBuilder(Material.STAINED_GLASS_PANE).setDamage(4).setName("  ").build());
		setItem(26, new ItemBuilder(Material.STAINED_GLASS_PANE).setDamage(4).setName("  ").build());
		...
		setItem(36, new ItemBuilder(Material.STAINED_GLASS_PANE).setDamage(4).setName("  ").build());
		setItem(37, new ItemBuilder(Material.STAINED_GLASS_PANE).setDamage(0).setName("  ").build());
		setItem(38, new ItemBuilder(Material.STAINED_GLASS_PANE).setDamage(4).setName("  ").build());
		setItem(39, new ItemBuilder(Material.STAINED_GLASS_PANE).setDamage(0).setName("  ").build());
		setItem(40, new ItemBuilder(Material.STAINED_GLASS_PANE).setDamage(4).setName("  ").build());
		setItem(41, new ItemBuilder(Material.STAINED_GLASS_PANE).setDamage(0).setName("  ").build());
		setItem(42, new ItemBuilder(Material.STAINED_GLASS_PANE).setDamage(4).setName("  ").build());
		setItem(43, new ItemBuilder(Material.STAINED_GLASS_PANE).setDamage(0).setName("  ").build());
		setItem(44, new ItemBuilder(Material.STAINED_GLASS_PANE).setDamage(4).setName("  ").build());
	...
	public void onClick(int position, ItemStack item, ClickType click) {
		...
		if(position == 25){
			...
			QueuesManager.addQueue(player, Queues.UNRANKED_NODEBUFF);
		}
