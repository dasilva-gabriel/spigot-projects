...
public class SanctionGui extends Gui{
	
	public SanctionGui(Player player, Player target) {
	...
	public void drawScreen() {
		...
		setItem(0, new HeadBuilder(target.getName()).setName("§7Joueur §8» §e"+target.getName()).build());
		...
		setItem(8, new ItemBuilder(Material.BLAZE_POWDER).setName("§8[§3»§8] §bInfraction administrative. §8(§cRéservé aux AdminG et Fondateurs§8)").build());
